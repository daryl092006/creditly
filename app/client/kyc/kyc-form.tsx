                                ...
                                <div className="p-6 bg-slate-950/80 border border-slate-800 rounded-2xl space-y-6">
                                    ...
                                    <div className="space-y-4">
                                        {missingFields.includes('nom') && (
                                            <div>
                                                <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-2">Nom de Famille (Identique CNI)</label>
                                                <input name="nom" type="text" required className="w-full bg-slate-900 border border-slate-800 rounded-xl px-4 py-3 text-xs font-bold text-white outline-none focus:border-blue-500/50" />
                                            </div>
                                        )}
                                        {missingFields.includes('prenom') && (
                                            <div>
                                                <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-2">Prénom</label>
                                                <input name="prenom" type="text" required className="w-full bg-slate-900 border border-slate-800 rounded-xl px-4 py-3 text-xs font-bold text-white outline-none focus:border-blue-500/50" />
                                            </div>
                                        )}
                                        {missingFields.includes('birth_date') && (
                                            <div>
                                                <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-2">Date de Naissance</label>
                                                <input name="birth_date" type="date" required className="w-full bg-slate-900 border border-slate-800 rounded-xl px-4 py-3 text-xs font-bold text-white outline-none focus:border-blue-500/50" />
                                            </div>
                                        )}
                                        {missingFields.includes('profession') && (
                                            <div>
                                                <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-2">Profession</label>
                                                <input name="profession" type="text" required className="w-full bg-slate-900 border border-slate-800 rounded-xl px-4 py-3 text-xs font-bold text-white outline-none focus:border-blue-500/50" />
                                            </div>
                                        )}
                                        {missingFields.includes('whatsapp') && (
                                            <div>
                                                <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-2">Numéro WhatsApp</label>
                                                <input name="whatsapp" type="text" placeholder="+229 00 00 00 00" required className="w-full bg-slate-900 border border-slate-800 rounded-xl px-4 py-3 text-xs font-bold text-white outline-none focus:border-blue-500/50" />
                                            </div>
                                        )}
                                        {missingFields.includes('guarantor_nom') && (
                                            <div className="pt-4 border-t border-slate-800">
                                                <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-2">Nom de la Personne de Référence</label>
                                                <input name="guarantor_nom" type="text" required className="w-full bg-slate-900 border border-slate-800 rounded-xl px-4 py-3 text-xs font-bold text-white outline-none focus:border-blue-500/50" />
                                            </div>
                                        )}
                                        {missingFields.includes('guarantor_prenom') && (
                                            <div>
                                                <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-2">Prénom de la Personne de Référence</label>
                                                <input name="guarantor_prenom" type="text" required className="w-full bg-slate-900 border border-slate-800 rounded-xl px-4 py-3 text-xs font-bold text-white outline-none focus:border-blue-500/50" />
                                            </div>
                                        )}
                                        {missingFields.includes('guarantor_whatsapp') && (
                                            <div>
                                                <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 mb-2">WhatsApp de la Personne de Référence</label>
                                                <input name="guarantor_whatsapp" type="text" required placeholder="+229 00 00 00 00" className="w-full bg-slate-900 border border-slate-800 rounded-xl px-4 py-3 text-xs font-bold text-white outline-none focus:border-blue-500/50" />
                                            </div>
                                        )}
                                    </div>
                                </div>
