    ...
    return (
        <div className="py-10 md:py-16 animate-fade-in">
            <div className="main-container space-y-12">
                ...
                {/* Global Quotas Monitor Section - Compact */}
                                ...
                                return (
                                    <div key={amt} className="space-y-2">
                                        ...
                                        <div className="h-1 w-full bg-slate-800 rounded-full overflow-hidden">
                                            <div
                                                className={`h-full transition-all duration-1000 ${exceeded ? 'bg-red-500 animate-pulse' : remaining === 0 ? 'bg-amber-500' : 'bg-emerald-500'}`}
