...
const url = 'https://dbunwqgfakqcazjkyagd.supabase.co/rest/v1/global_quotas?select=*';
...
https.get(url, options, (res) => {
  ...
  res.on('end', () => {
    fs.writeFileSync('d:/creditly/tmp/quotas_output.json', data);
    console.log('Saved to d:/creditly/tmp/quotas_output.json');
  });
}).on('error', (err) => {
