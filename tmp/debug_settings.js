...
const url = 'https://dbunwqgfakqcazjkyagd.supabase.co/rest/v1/system_settings?select=*';
...
https.get(url, options, (res) => {
  ...
  res.on('end', () => {
    fs.writeFileSync('d:/creditly/tmp/settings_debug.json', data);
    console.log('Saved to d:/creditly/tmp/settings_debug.json');
  });
}).on('error', (err) => {
